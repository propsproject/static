...
var submitMailChimpForm = function (form) {
  ...
  window.mcFields = form.querySelector('.mc-fields');
...
document.addEventListener('blur', function (event) {
  ...
  if (event.target.form === null || event.target.form === undefined || !event.target.form.classList.contains('validate')) return;
